# slp.spec
#
# Copyright (c) 2012 Reiner Jung rju@informatik.uni-kiel.de
#
%define name slp
...
#Icon:
#URL:
#Packager: Reiner Jung rju@informatik.uni-kiel.de
...
Summary: Simplify the writing of beamer tex slides by providing shorthand macros

%description
Simplify the writing of beamer tex slides by providing shorthand macros
slp.spec.  Generated from slp.spec.in by configure.
Please edit slp.spec.in to add several more lines of description
